...
3. Read `.gemini/EVOLUTION.md` (For the current roadmap phase).
4. Read `.gemini/STRUCTURE.md` (To accurately locate files, module component trees, and core infrastructure).
5. Read `.gemini/SCHEMA.md` (To understand the strict TypeScript interfaces for core entities).
